      ...
      return (
        <div className="fixed top-0 z-40 grid h-1/6 w-full bg-header px-8 py-4 text-3xl font-bold text-description">
          <div className="flex items-center gap-2">
            ...
            <Link
              className="rounded-2xl p-2 px-4 text-txt border-4 border-bdr bg-btn_2 transition-colors hover:bg-btn_2/30"
              href={{
                pathname: `/auth/login`,
              }}
            >
            ...
            <Link
              className="rounded-2xl p-2 px-4 text-txt border-4 border-bdr bg-btn transition-colors hover:bg-btn/30"
              href={{
