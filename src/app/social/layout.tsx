  ...
  return (
    ...
    <main className="flex h-screen w-full flex-col justify-center overflow-y-scroll md:overflow-hidden">
      ...
      <div className="flex-rows md:flex h-5/6 bg-brand_2">
        <nav className="h-[280px] h-full lg:h-full md:flex md:w-2/5 md:my-20 lg:my-0 lg:w-1/5 min-w-min flex-col justify-start overflow-y-auto border-r bg-nav">
          <FriendList />
        </nav>
        {/* overflow-y-scroll for child to show scrollbar */}
        <div className="w-full md:h-[60%] md:mt-30 lg:mt-0 md:w-4/5 overflow-y-auto">{children}</div>
      </div>
    </main>
  );
}
