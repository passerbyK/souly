  ...
  return (
    <div className="flex h-full bg-brand_2">
      <div className="relative m-4 flex w-full flex-col overflow-y-auto rounded-2xl bg-nav p-4">
        ...
        <p className="hidden p-2 text-2xl text-txt_7 md:text-4xl lg:block">
          Your friends
        </p>
        ...
        <div className="absolute bottom-4 hidden w-10/12 flex-col gap-4 lg:flex xl:flex-row xl:gap-6">
          <AddDialog />
          <RequestDialog />
        </div>
      </div>
