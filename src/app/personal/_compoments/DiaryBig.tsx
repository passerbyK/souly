...
function DiaryBig() {
  return (
    <div className="flex w-full gap-2">
      <div className="h-full w-[65%] rounded-2xl border-2 border-solid border-[#7C5A16] bg-white">
      ...
      <div className="h-full w-[35%] rounded-2xl border-2 border-solid border-[#7C5A16] bg-white"></div>
    </div>
  );
}
