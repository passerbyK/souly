...
function Header() {
  return (
    <div className="flex h-full w-full items-center gap-2 bg-header px-8 py-4 text-xl font-bold text-[#DF8558]">
      ...
      <div className="text-3xl hover:rounded-2xl p-2 px-4 transition-colors hover:bg-[#D88253]/30 cursor-pointer">
        <IoIosNotificationsOutline />
      </div>
      <div className="text-5xl text-black mx-2 hover:cursor-pointer">
        <IoPersonCircleSharp />
      </div>
    </div>
  );
