...
function Header() {
  return (
    <div className="flex h-full w-full items-center gap-2 bg-header px-8 py-4 text-3xl font-bold text-[#DF8558]">
      ...
      <div className="cursor-pointer p-2 px-4 text-3xl transition-colors hover:rounded-full hover:bg-[#D88253]/30">
